...
public class level18 : GeneralControls {
	...
	Animator lampanime;
	string[] lamp = {"brown","black","black","black","black","white","yellow","teal"};
    ...
    GameObject temp2;
    GameObject temp3;
    string levelcomplete = "level18complete";
    string nextlevel = "level19story";
    string currentlevel = "level18";
