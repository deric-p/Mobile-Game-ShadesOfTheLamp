...
public class level19 : GeneralControls {
	...
	Animator lampanime;
	string[] lamp = {"black","pink","pink","pink","pink","teal","teal","teal","teal","green","green"};
    ...
    GameObject temp2;
    GameObject temp3;
    string levelcomplete = "level19complete";
    string nextlevel = "level20";
    string currentlevel = "level19";
    string levelselector = "LevelSelectorMysticSwamp";
