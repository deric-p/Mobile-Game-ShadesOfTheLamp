...
public class level15 : GeneralControls {
    ...
    Animator lampanime;
	string[] lamp = {"red","blue","teal","teal","white","white","green"};
    ...
    GameObject temp2;
    GameObject temp3;
    string levelcomplete = "level15complete";
    string nextlevel = "level16";
    string currentlevel = "level15";
