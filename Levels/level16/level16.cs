...
public class level16 : GeneralControls {
    ...
    Animator lampanime;
	string[] lamp = {"black","black","white","white","pink","orange","grey"};
    ...
    GameObject temp2;
    GameObject temp3;
    string levelcomplete = "level16complete";
    string nextlevel = "level17";
    string currentlevel = "level16";
