...
public class level13 : GeneralControls {
    ...
    Animator lampanime;
	string[] lamp = {"red","blue","green","pink","teal"};
    ...
    GameObject temp2;
    GameObject temp3;
    string levelcomplete = "level13complete";
    string nextlevel = "level14";
    string currentlevel = "level13";
