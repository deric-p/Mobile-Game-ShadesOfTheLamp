...
public class level17 : GeneralControls {
	...
	Animator lampanime;
	string[] lamp = {"purple","teal","yellow","red","blue","green","black","black","orange","orange"};
    ...
    GameObject temp2;
    GameObject temp3;
    string levelcomplete = "level17complete";
    string nextlevel = "level18";
    string currentlevel = "level17";
